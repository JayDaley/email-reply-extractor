"""Unit tests for the HTML-as-oracle helper (:mod:`email_reply_extractor.html_text`).
...
from email_reply_extractor.html_text import HtmlParts, html_to_text, split_html_parts
